...
@Component({
  selector: 'app-edit-physio',
  templateUrl: './edit-physio.component.html',
  styleUrls: ['./edit-physio.component.css'],
})
export class EditPhysioComponent implements OnInit {
  constructor(
  ...
  public updateDetails() {
    ...
    if (this.cash == false && this.creditCard == false &&  this.wallet == false&&this.ProviderPay==false) {
