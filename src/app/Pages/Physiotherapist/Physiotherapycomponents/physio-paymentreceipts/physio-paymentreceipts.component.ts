...
@Component({
  selector: 'app-physio-paymentreceipts',
  templateUrl: './physio-paymentreceipts.component.html',
  styleUrls: ['./physio-paymentreceipts.component.css']
})
export class PhysioPaymentreceiptsComponent implements OnInit {
  ...
  async UpdateReceipt() {
    ...
    this.NurseService.UpdateBook_Physio_AppointmentPdfUrl(entity).subscribe(async data => {
