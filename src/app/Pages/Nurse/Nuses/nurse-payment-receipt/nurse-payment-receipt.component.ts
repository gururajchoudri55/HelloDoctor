...
@Component({
  selector: 'app-nurse-payment-receipt',
  templateUrl: './nurse-payment-receipt.component.html',
  styleUrls: ['./nurse-payment-receipt.component.css']
})
export class NursePaymentReceiptComponent implements OnInit {
  ...
  async UpdateReceipt() {
    ...
    this.NurseService.UpdateBook_Nurse_AppointmentPdfUrl(entity).subscribe(async data => {
