...
@Component({
  selector: 'app-midwife-availability',
  templateUrl: './midwife-availability.component.html',
  styleUrls: ['./midwife-availability.component.css']
})
export class MidwifeAvailabilityComponent implements OnInit {
  ...
  getDoctorAvailableReport() {
    this.MenuService.GetMidwifeTimeWiseWeb(this.dayID, this.AppointmentDate, this.AppointmentTypeID, this.typeID, this.DepartmentID).subscribe(async data => {
      this.loader = false;
