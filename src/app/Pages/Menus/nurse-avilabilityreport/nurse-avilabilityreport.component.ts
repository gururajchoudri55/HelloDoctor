...
@Component({
  selector: 'app-nurse-avilabilityreport',
  templateUrl: './nurse-avilabilityreport.component.html',
  styleUrls: ['./nurse-avilabilityreport.component.css']
})
export class NurseAvilabilityreportComponent implements OnInit {
  ...
  getDoctorAvailableReport() {
    this.MenuService.GetNurseTimeWiseWeb(this.dayID, this.AppointmentDate, this.AppointmentTypeID, this.typeID, this.DepartmentID).subscribe(async data => {
      this.loader = false;
