...
@Component({
  selector: 'app-inclinic-revenue',
  templateUrl: './inclinic-revenue.component.html',
  styleUrls: ['./inclinic-revenue.component.css'],
})
export class InclinicRevenueComponent implements OnInit {
  startdate: any;
  enddate: any;
  bsRangeValue: any;
  p: any;
  ...
  ngOnInit(): void {
    ...
    this.ActivatedRoute.params.subscribe((params) => {
      ...
      this.GetAllInClinicRevenueReports();
  ...
  public GetAllInClinicRevenueReports() {
    debugger;
    this.CommonService.GetAllInClinicRevenueReports(
      0,
      this.startdate,
      this.enddate,
      this.typeid
